package fitnesstrackerapplication.rest.configuration;

import fitnesstrackerapplication.core.service.UserService;
import fitnesstrackerapplication.rest.filters.JwtAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        request -> request
                                .requestMatchers(HttpMethod.GET, "/api/workoutPlans/**").permitAll()
                                //.requestMatchers("/api/workoutPlans/**").authenticated()
